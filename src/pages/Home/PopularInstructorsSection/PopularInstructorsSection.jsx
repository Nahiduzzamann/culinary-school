...
const PopularInstructorsSection = () => {
  // Replace with your actual instructor data
  const instructors = [
    {
      id: 1,
      name: 'John Doe',
    ...
    <div className="container mx-auto my-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {topInstructors.map((instructor) => (
          <div key={instructor.id} className="bg-white rounded shadow overflow-hidden">
            <img src={instructor.image} alt={instructor.name} className="w-full h-40 object-cover" />
            <div className="p-4">
